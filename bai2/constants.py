...
TypeCodes = [
    ...
    TypeCode('920', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'SERVICE CHARGE REBATE'),
    TypeCode('921', None, TypeCodeLevel.detail, 'Type Code 921'),
    TypeCode('922', None, TypeCodeLevel.detail, 'Type Code 922'),
    TypeCode('923', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'REFUND UNCOLLECTED FUNDS CHG'),
    TypeCode('924', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'TRANSFER FROM FUNDING SOURCE'),
    TypeCode('925', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'AUTOMATIC TRANSFER DEPOSIT'),
    TypeCode('926', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'CREDIT TO CLOSE ACCOUNT'),
    TypeCode('927', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'SAVINGS TRANSFER FOR OVERDRAFT'),
    TypeCode('928', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'TRANSFER OF ACCOUNT CREDIT'),
    TypeCode('929', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'TRANSFER ACCOUNT BALANCE'),
    TypeCode('930', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'MARINER FUND REDEMPTION'),
    TypeCode('931', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'PAY DEPOSIT FROM YOUR EMPLOYER'),
    TypeCode('932', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'NIGHT DEPOSIT ENVELOPE'),
    TypeCode('933', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'MARINER FUND REDEM TAX FREE'),
    TypeCode('934', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'FED TAX ADJ OVERWITHHOLDING'),
    TypeCode('935', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'BROKERAGE SERVICE CREDIT'),
    TypeCode('936', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'REFUND OF BILL PAYER SVC CHG'),
    TypeCode('937', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'BILL PAYER CORRECTION'),
    TypeCode('938', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'SPECIAL NEXT DAY CREDIT'),
    TypeCode('939', None, TypeCodeLevel.detail, 'Type Code 939'),
    TypeCode('940', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'SPECIAL NEXT DAY CREDIT-2DF'),
    TypeCode('941', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'SPECIAL NEXT DAY CREDIT-3DF'),
    TypeCode('942', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'TRANSFER OF ACCOUNT CREDIT'),
    TypeCode('943', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'BALANCE MANAGER REDEMPTION'),
    TypeCode('944', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'BROKERAGE SERVICE-SALE'),
    TypeCode('945', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'ATM/ELECTRONIC BANKING TRANS'),
    TypeCode('946', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'DEPOSIT FROM U.S. TREASURY'),
    TypeCode('947', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'ACH CREDIT'),
    TypeCode('948', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'BROKERAGE SVC-DIVIDEND COUPON'),
    TypeCode('949', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'INITIAL DEPOSIT'),
    TypeCode('950', None, TypeCodeLevel.detail, 'Type Code 950'),
    TypeCode('951', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'FOREIGN EXCHANGE CREDIT-1DF'),
    TypeCode('952', None, TypeCodeLevel.detail, 'Type Code 952'),
    TypeCode('953', TypeCodeTransaction.credit, TypeCodeLevel.detail, 'CHECK REVERSAL-UNAVAILABLE'),
    TypeCode('954', None, TypeCodeLevel.detail, 'Type Code 954'),
    TypeCode('955', None, TypeCodeLevel.detail, 'Type Code 955'),
    TypeCode('956', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'MISCELLANEOUS DEBIT'),
    TypeCode('957', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'MISCELLANEOUS DEBIT'),
    ...
    TypeCode('962', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'MISCELLANEOUS CHARGE'),
    TypeCode('963', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'SERVICE CHARGE-INSUFFICIENT'),
    TypeCode('964', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'SERVICE CHARGE-UNAVAILABLE'),
    TypeCode('965', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'LINE OF CREDIT PAYMENT'),
    TypeCode('966', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'CHECK CASHING SERVICE CHARGE'),
    TypeCode('967', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'DEBIT TO CLOSE ACCOUNT'),
    ...
    TypeCode('970', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'TRANSFER OF ACCOUNT DEBIT'),
    TypeCode('971', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'PAYMENT MADE PER REQUEST'),
    TypeCode('972', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'TRANSFER ACCOUNT BALANCE'),
    TypeCode('973', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'DUE FROM BANK-DEP DF1'),
    TypeCode('974', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'DUE FROM BANK-DEP DF2'),
    TypeCode('975', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'DUE FROM BANK-DEP DF3'),
    TypeCode('976', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'MARINER FUND ADJUSTMENT'),
    TypeCode('977', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'INTEREST ADJUSTMENT DEBIT'),
    TypeCode('978', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'MARINER FUND PURCHASE'),
    TypeCode('979', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'CHECKBOOK SUPPLIES CHARGE'),
    TypeCode('980', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'MARINER FUND PURCHASE-TAX FREE'),
    TypeCode('981', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'FEDERAL TAX ADJUSTMENT'),
    TypeCode('982', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'BACK VALUE ADJUSTMENT'),
    TypeCode('983', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'TELEPHONE TRANSFER'),
    TypeCode('984', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'INTERNATIONAL MONEY ORDER'),
    TypeCode('985', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'BROKERAGE SERVICE DEBIT'),
    TypeCode('986', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'OFFICIAL CHECK PURCHASE'),
    TypeCode('987', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'DEFER DEBIT-2-DF'),
    TypeCode('988', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'DEFER DEBIT-3-DF'),
    TypeCode('989', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'BALANCE MANAGER SERVICE CHARGE'),
    TypeCode('990', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'TRANSFER OF ACCOUNT DEBIT'),
    TypeCode('991', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'BALANCE MANAGER PURCHASE'),
    TypeCode('992', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'CHECKBOOK SUPPLIES CHARGE'),
    TypeCode('993', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'MARINELEADER SERVICE CHARGE'),
    TypeCode('994', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'BILL PAYER PAYMENT'),
    TypeCode('995', TypeCodeTransaction.debit, TypeCodeLevel.detail, 'CHECK PAID-INSUFFICIENT FUNDS'),
