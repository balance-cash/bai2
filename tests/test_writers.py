...
from bai2 import constants, models, writers
...
class TransactionDetailWriterTestCase(TestCase):
    ...
    def test_transaction_detail_with_distributed_availability_simple_renders_correctly(
        self,
    ):
        transaction = models.TransactionDetail(
            type_code=constants.TypeCodes["399"],
    ...
    def test_transaction_detail_with_value_dated_availability_renders_correctly(self):
        transaction = models.TransactionDetail(
            ...
            availability=OrderedDict(
                [("date", date(year=2015, month=10, day=1)), ("time", None)]
            ),
            text="BILLS",
        )
    ...
    def test_account_identifier_with_continuation_renders_correctly(self):
        account_identifier = models.AccountIdentifier(
            ...
            summary_items=[
                ...
                models.Summary(
                    type_code=constants.TypeCodes["400"], amount=10000, item_count=175
                ),
                models.Summary(
                    type_code=constants.TypeCodes["100"], amount=10000, item_count=50
                ),
            ],
        )
